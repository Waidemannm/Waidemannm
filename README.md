# Eu sou o Moisés Waidemann, Estudante de Análise e Desenvolvimento de Sistemas na FIAP! 💻

💡 Sou apaixonado por desenvolver soluções eficientes e escaláveis, especialmente no Back-End, mas sempre curioso para explorar novas tecnologias e áreas do desenvolvimento.

🔍 Tenho experiência e estudo em Java, Python, bancos de dados e APIs REST, e busco aplicar boas práticas de código limpo, performance e arquitetura de sistemas.

📊 Também tenho interesse em análise de dados, pipelines de ETL e inteligência aplicada, integrando dados para gerar insights valiosos.

🤝 Aberto a oportunidades, projetos desafiadores e colaborações que me permitam crescer como desenvolvedor full-stack e analista de dados.
